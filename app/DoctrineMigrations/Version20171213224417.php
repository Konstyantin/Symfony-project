 ...
 */
class Version20171213224417 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE model CHANGE image_name image_name VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE model CHANGE image_name image_name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
