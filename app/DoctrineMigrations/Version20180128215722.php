 ...
 */
class Version20180128215722 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE offers_category ADD offers_category_image_id INT DEFAULT NULL, ADD description LONGTEXT NOT NULL');
        $this->addSql('ALTER TABLE offers_category ADD CONSTRAINT FK_DE28C23B53E474EC FOREIGN KEY (offers_category_image_id) REFERENCES media__media (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_DE28C23B53E474EC ON offers_category (offers_category_image_id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_DE28C23B53E474EC ON offers_category');
        $this->addSql('ALTER TABLE offers_category DROP offers_category_image_id, DROP description');
    }
}
