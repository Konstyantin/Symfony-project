 ...
 */
class Version20180123204538 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE offers ADD CONSTRAINT FK_DDEA011112469DE2 FOREIGN KEY (category_id) REFERENCES offers_category (id)');
        $this->addSql('CREATE INDEX IDX_DDEA011112469DE2 ON offers (category_id)');
        $this->addSql('ALTER TABLE offers RENAME INDEX uniq_da460427e5c1fe97 TO UNIQ_DDEA0111E5C1FE97');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_DDEA011112469DE2 ON Offers');
        $this->addSql('ALTER TABLE Offers DROP category_id');
        $this->addSql('ALTER TABLE Offers RENAME INDEX uniq_ddea0111e5c1fe97 TO UNIQ_DA460427E5C1FE97');
    }
}
