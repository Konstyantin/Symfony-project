 ...
 */
class Version20180123195858 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE offers_category (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_DE28C23B727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE offers_category ADD CONSTRAINT FK_DE28C23B727ACA70 FOREIGN KEY (parent_id) REFERENCES offers_category (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE offers_category');
    }
}
