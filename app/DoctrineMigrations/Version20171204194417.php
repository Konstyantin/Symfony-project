 ...
 */
class Version20171204194417 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE feature ADD car_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE feature ADD CONSTRAINT FK_1FD77566C3C6F69F FOREIGN KEY (car_id) REFERENCES car (id)');
        $this->addSql('CREATE INDEX IDX_1FD77566C3C6F69F ON feature (car_id)');
        ...
        $this->addSql('DROP INDEX IDX_773DE69D60E4B879 ON car');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX IDX_773DE69D60E4B879 ON car (feature_id)');
        ...
        $this->addSql('DROP INDEX IDX_1FD77566C3C6F69F ON feature');
        $this->addSql('ALTER TABLE feature DROP car_id');
    }
}
