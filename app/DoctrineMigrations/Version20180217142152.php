 ...
 */
class Version20180217142152 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE car ADD slug VARCHAR(45) NOT NULL, CHANGE name name VARCHAR(45) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE car DROP slug, CHANGE name name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
