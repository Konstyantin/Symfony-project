 ...
 */
class Version20180304135704 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE principles (id INT AUTO_INCREMENT NOT NULL, principles_image_id INT DEFAULT NULL, title VARCHAR(45) NOT NULL, short_description VARCHAR(45) NOT NULL, description LONGTEXT NOT NULL, slug VARCHAR(128) NOT NULL, UNIQUE INDEX UNIQ_3E8DCFE1989D9B62 (slug), UNIQUE INDEX UNIQ_3E8DCFE14A1F4DD1 (principles_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE principles ADD CONSTRAINT FK_3E8DCFE14A1F4DD1 FOREIGN KEY (principles_image_id) REFERENCES media__media (id) ON DELETE CASCADE');
