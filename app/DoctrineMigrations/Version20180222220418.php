 ...
 */
class Version20180222220418 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE dealer CHANGE phone phone VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE dealer CHANGE phone phone INT NOT NULL');
    }
}
