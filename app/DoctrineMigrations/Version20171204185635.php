 ...
 */
class Version20171204185635 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE car ADD feature INT DEFAULT NULL');
        $this->addSql('ALTER TABLE car ADD CONSTRAINT FK_773DE69D1FD77566 FOREIGN KEY (feature) REFERENCES feature (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_773DE69D1FD77566 ON car (feature)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE car DROP FOREIGN KEY FK_773DE69D1FD77566');
        $this->addSql('DROP INDEX UNIQ_773DE69D1FD77566 ON car');
        $this->addSql('ALTER TABLE car DROP feature');
