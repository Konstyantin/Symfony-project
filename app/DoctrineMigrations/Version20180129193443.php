 ...
 */
class Version20180129193443 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Offers CHANGE short_description short_description LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Offers CHANGE short_description short_description VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
