 ...
 */
class Version20180131204349 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_car (id INT AUTO_INCREMENT NOT NULL, model_id INT DEFAULT NULL, user_id INT DEFAULT NULL, car_name VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, years INT NOT NULL, INDEX IDX_9C2B87167975B7E7 (model_id), INDEX IDX_9C2B8716A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
