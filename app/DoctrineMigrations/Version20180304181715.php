 ...
 */
class Version20180304181715 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE news (id INT AUTO_INCREMENT NOT NULL, news_image_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, short_description LONGTEXT NOT NULL, description LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_1DD39950749B863C (news_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE news ADD CONSTRAINT FK_1DD39950749B863C FOREIGN KEY (news_image_id) REFERENCES media__media (id) ON DELETE CASCADE');
