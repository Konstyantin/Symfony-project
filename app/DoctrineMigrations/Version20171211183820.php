 ...
 */
class Version20171211183820 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE feature ADD image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE feature ADD CONSTRAINT FK_1FD775663DA5256D FOREIGN KEY (image_id) REFERENCES media__gallery_media (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1FD775663DA5256D ON feature (image_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C13DA5256D FOREIGN KEY (image_id) REFERENCES media__gallery_media (id)');
        ...
        $this->addSql('ALTER TABLE feature DROP FOREIGN KEY FK_1FD775663DA5256D');
        $this->addSql('DROP INDEX UNIQ_1FD775663DA5256D ON feature');
        $this->addSql('ALTER TABLE feature DROP image_id');
    }
}
