 ...
 */
class Version20180226181202 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE feature CHANGE full_description full_description TINYTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE feature CHANGE full_description full_description VARCHAR(45) NOT NULL COLLATE utf8_unicode_ci');
    }
}
