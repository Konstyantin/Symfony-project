 ...
 */
class Version20180131210511 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_car CHANGE years created_at INT NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_car CHANGE created_at years INT NOT NULL');
    }
}
