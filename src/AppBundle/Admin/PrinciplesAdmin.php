 ...
 */
class PrinciplesAdmin extends AbstractAdmin
{
    /**
     * @var string $translationDomain
     */
    protected $translationDomain = 'SonataPrinciplesBundle';
    ...
    public function configureFormFields(FormMapper $form)
    {
        $form
            ->add('title', TextType::class, [
                ...
                'translation_domain' => 'SonataPrinciplesBundle',
                'required' => false,
                'attr' => [
